...
def main():
    ...
    # Init
    plt.close("all")
    outdir = "json-analysis"
    if not os.path.exists(outdir):
        os.makedirs(outdir)

    # Extract a given parameter and corresponding statistics
    param = "zini"
    infile = os.path.join("output_016_diffusion_FeH_Teff_r012_corr_nottrusted_5p", "Kepler444.json")
    gridf = os.path.join("..", "input", "Garstec_AS09_Kepler444_diff.hdf5")
